...
# Simulations ECN
# Simulations ECN - VERSION CORRIGÉE
    ...
    # Gestion des onglets avec des clés uniques
    ...
    with tab1:
        ...
        **Caractéristiques:**
        - ⏱️ **Durée :** 60 minutes
        - 📝 **120 questions** en 4 sections
        - 🏥 **Toutes spécialités** mélangées
        - 📊 **Barème ECN** avec pénalités
    ...
    if st.session_state.get('ecn_simulation_active') and not st.session_state.get('ecn_simulation_finished'):
        ...
        # Navigation entre sections - AVEC GESTION D'ÉTAT
    ...
    # AFFICHAGE DES RÉSULTATS
        ...
        # Affichage du détail des réponses
